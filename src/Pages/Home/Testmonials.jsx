      ...
      <div className="portfolio--section--container">
        {data?.testimonial?.map((item, index) => (
          <div key={index} className="testimonial--section--card">
            ...
            <div className="testimonial--card--author--detail">
              <img src={item.src} alt="avatar" />
              <div>
                <p className="text-md testiomial--author--name">{item.author_name}</p>
                <p className="text-md testimonial--author--designation">{item.autohor_designation}</p>
